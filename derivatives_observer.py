...
def evaluate_derivatives(symbol: str, funding_rate: Any = None, oi_now: Any = None, oi_prev: Any = None, long_short_ratio: Any = None, taker_buy_sell_ratio: Any = None) -> dict[str, Any]:
