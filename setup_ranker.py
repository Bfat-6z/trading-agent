...
def rank_setup(row: dict[str, Any]) -> dict[str, Any]:
    ...
    base_expectancy = safe_float(row.get("expectancy"))
    review_expectancy = row.get("review_expectancy")
    expectancy = safe_float(review_expectancy, base_expectancy) if review_expectancy is not None else base_expectancy
