...
LEVERAGE = 30
SL_PRICE = 1.050
TP_PRICE = 1.090  # mid-target TP1.5
...
if mark > 1.080:
    print(f"[WARN] Price moved up >$1.080 since recommendation. Aborting to avoid chase.")
    print(f"Wait for pullback to $1.069-1.075 area.")
    exit(0)
